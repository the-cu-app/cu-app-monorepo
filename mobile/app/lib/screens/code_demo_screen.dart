...
class _CodeDemoScreenState extends State<CodeDemoScreen>
  ...
  final List<AcquisitionSlide> _slides = [
    AcquisitionSlide(
      ...
      description:
          "A complete digital transformation roadmap that will revolutionize credit union banking",
      code: """
\$ flutter create cu_app
Creating project cu_app...
Running "flutter pub get" in cu_app...
...
✓ Project created successfully!""",
    ...
    AcquisitionSlide(
      ...
      description:
          "Flutter + Supabase + AI = The future of credit union member experience",
      code: """
...
✓ Building next-gen banking app...""",
    ...
    AcquisitionSlide(
      ...
      description:
          "Real-time transactions, AI assistance, and seamless integration with modern fintech",
      code: """
class BankingService {
  Future<Account> getBalance() async {
    ...
    AcquisitionSlide(
      ...
      description:
          "Personalized financial insights, automated assistance, and predictive analytics",
      code: """
\$ flutter build ios --release
Building com.suncoast.app for device (ios-release)...
Running Xcode build...
...
✓ App ready for deployment!""",
    ...
    AcquisitionSlide(
      ...
      description:
          "Transform your credit union with cutting-edge technology built by industry experts",
      code: """
...
✓ Successfully deployed to production
 App is live!""",
  ...
  void _startTerminalAnimation() {
    final commands = [
      "\$ cd /Users/suncoast/projects",
      "\$ flutter doctor",
      "✓ Flutter: Channel stable, 3.24.0",
      "✓ Xcode: version 15.0",
      "\$ flutter create suncoast_banking",
      "Creating project suncoast_banking...",
      "\$ cd suncoast_banking",
      "\$ code .",
      "Opening VS Code...",
      "\$ flutter run",
                      ...
                      onPressed: () {
                        if (_currentPage < _slides.length - 1) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Ready to build the future!'),
