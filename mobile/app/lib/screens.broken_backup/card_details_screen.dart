...
''';
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Card details copied to clipboard)),
      ...
      if (success && mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Virtual card deleted)),
      ...
      builder: (context) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Card reported and locked. Replacement on the way.)),
    ...
    // In a real app, this would update the primary card status
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Card set as primary)),
