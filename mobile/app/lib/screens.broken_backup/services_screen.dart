...
import 'analytics/net_worth_screen.dart';
      ...
      child: InkWell(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Loan applications coming soon!)),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Account opening coming soon!)),
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          title: const Text('Request Redesign'),
                          subtitle: Text('Search for ${CUConfigService().cuName} redesign'),
                          leading: const Icon(Icons.search),
                          onTap: () => launch(CUConfigService().getSupportUrl()),
                        ),
                        const ListTile(
      ...
      child: Padding(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(QR Scanner launching...)),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            SnackBar(content: Text(Opening appointment scheduler...)),
